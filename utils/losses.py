...
def bernoulli_loss(x_true,x_recons,
    ...
    #Seems like the sigmoid is not needed here, removing the F.sigmoid over the x_recons_reshaped
    loss = torch.sum(F.binary_cross_entropy_with_logits(input=x_recons_reshaped, target=x_true_reshaped,
